...
#        sys.exit
    ...
    testfilename = "/home/gibson/jonask/Dropbox/Ann-Survival-Phd/publication_data/hard_survival_test_val_noisyindata.txt"
    ...
    #designs = [(1, 'linear')]
    designs = []
    [designs.append((i, 'tanh')) for i in [12, 14, 16, 18, 20]]
    ...
    #winning_design = (4, 'tanh')
    
    print("\nTraining the winning design {0}...".format(str(winning_design)))
    model_file = train_model(winning_design, filename, columns, targets, comsize_third = 10, epochs = 300, 
                             **train_kwargs)
